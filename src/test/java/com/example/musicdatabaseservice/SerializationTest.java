...
import com.example.musicdatabaseservice.config.Config;
import com.example.musicdatabaseservice.deezer.model.Album;
import com.example.musicdatabaseservice.deezer.model.Artist;
import com.example.musicdatabaseservice.deezer.model.Genre;
import com.example.musicdatabaseservice.deezer.model.Track;
...
public class SerializationTest {
    ...
    void musicbrainzArtist() throws IOException {
        ...
        List<com.example.musicdatabaseservice.musicbrainz.model.Artist> list =
                (List<com.example.musicdatabaseservice.musicbrainz.model.Artist>) page.get(com.example.musicdatabaseservice.musicbrainz.model.Artist.class);
        com.example.musicdatabaseservice.musicbrainz.model.Artist artist = list.get(0);
        Assertions.assertThat(artist).hasNoNullFieldsOrProperties();
    }
