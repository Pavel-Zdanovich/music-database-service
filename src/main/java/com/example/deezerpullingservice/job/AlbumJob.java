...
import com.example.deezerpullingservice.service.AlbumService;
    ...
    public void executeInternal(JobExecutionContext context) {
        ...
        do {
            ...
            for (Album album : albums) {
                deezerService.getAsync(com.example.deezerpullingservice.deezer.model.Album.class, album.getId()).thenAccept(a -> {
